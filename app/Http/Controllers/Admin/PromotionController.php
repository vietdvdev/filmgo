...
class PromotionController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        $promotions = $query->orderBy('id', 'desc')->paginate(10)->withQueryString();
    ...
    public function store(Request $request): RedirectResponse
    {
        $request->validate([
            ...
            'quantity.integer'           => 'Tổng số lượng phát hành phải là số nguyên.',
            'quantity.min'               => 'Tổng số lượng phát hành phải lớn hơn hoặc bằng 1.',
