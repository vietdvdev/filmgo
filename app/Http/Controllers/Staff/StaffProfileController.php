...
{
    /**
     * Hiển thị trang quản lý tài khoản cá nhân nhân viên.
     */
    public function edit()
    {
        ...
        return view('staff.profile.edit', compact('user', 'cinema'));
    }
    ...
    public function updatePassword(Request $request)
    {
        ...
        return back()->with('success_password', 'Đổi mật khẩu tài khoản thành công!');
    }
}
