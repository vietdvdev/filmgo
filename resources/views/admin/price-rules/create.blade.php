...
@section('title', 'Thêm Quy Tắc Giá Mới - FilmGo')
...
<main class="flex-1 overflow-y-auto pt-16 bg-background">
    <div class="p-margin-page max-w-container-max mx-auto space-y-stack-lg">
        ...
        <div class="space-y-2">
            ...
            <h2 class="font-headline-lg text-headline-lg text-on-surface">Thêm Quy Tắc Giá Mới</h2>
        </div>

        <div class="bg-surface-container-lowest rounded-lg border border-outline-variant shadow-ambient-sm p-stack-lg max-w-3xl">
            <form action="{{ route('admin.price-rules.store') }}" method="POST" class="space-y-6">
                @csrf
                ...
                <div class="space-y-2">
                    ...
                    <div class="flex gap-6">
                        <label class="flex items-center gap-2 cursor-pointer">
                            <input type="radio" name="is_active" value="1" {{ old('is_active', true) ? 'checked' : '' }} class="w-4 h-4">
                    ...
                    <div class="flex gap-3">
                        ...
                        <div class="text-sm text-blue-800">
                            ...
                            <ul class="list-disc list-inside mt-2 space-y-1">
                                <li>Giờ vàng Thứ 7 (18:00-22:30): +20,000₫</li>
                                <li>Suất chiếu sớm (08:00-11:00): -15,000₫</li>
                                <li>Ngày lễ (00:00-23:59): +50,000₫</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex gap-3 pt-4 border-t border-outline-variant/30">
                    <button type="submit" class="bg-primary text-on-primary font-label-md text-label-md px-5 py-2.5 rounded-lg hover:bg-primary-container transition-colors flex items-center gap-2">
                        <span class="material-symbols-outlined" style="font-size: 18px;">check</span> Lưu Quy Tắc
                    </button>
