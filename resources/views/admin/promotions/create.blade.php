...
@section('title', 'Thêm Mới Khuyến Mãi - FilmGo')
...
<main class="flex-1 overflow-y-auto pt-16 bg-background">
    <div class="p-margin-page max-w-container-max mx-auto space-y-stack-lg">
        ...
        <div class="space-y-2">
            ...
            <h2 class="font-headline-lg text-headline-lg text-on-surface">Thêm Mã Khuyến Mãi Mới</h2>
        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-2">
                        ...
                        >
                            ...
                            <option value="fixed" {{ old('discount_type') == 'fixed' ? 'selected' : '' }}>Giảm tiền mặt cố định (đ)</option>
                        </select>
                        @error('discount_type')
                            <p class="text-error font-body-md text-xs mt-1">{{ $message }}</p>
                        @enderror
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-2">
                        ...
                        >
                            ...
                            <option value="inactive" {{ old('status') == 'inactive' ? 'selected' : '' }}>Ngưng hoạt động (Inactive)</option>
                        </select>
                        @error('status')
                            <p class="text-error font-body-md text-xs mt-1">{{ $message }}</p>
                        @enderror
