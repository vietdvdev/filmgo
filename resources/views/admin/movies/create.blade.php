...
<head>
    ...
    <title>Thêm Phim Mới - FilmGo</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .checkbox-item input[type=checkbox]:checked + label { color: #6d28d9; font-weight: 600; }
...
<div class="d-flex">
    ...
    <div class="main-content flex-grow-1">
        <div class="page-header">
            ...
            <h1><i class="bi bi-plus-circle me-2" style="color:#667eea;"></i>Thêm Phim Mới</h1>
        </div>
            ...
            <div class="row g-4">
                    ...
                    <div class="form-section">
                        ...
                        <div class="d-flex gap-4 align-items-start">
                            ...
                            <div class="flex-shrink-0">
                                <div class="poster-placeholder" id="placeholderDiv">
                            ...
                            <div class="flex-grow-1">
                                <div class="mb-3">
                                    <label class="form-label">Tải Lên Poster <small class="text-muted fw-normal">(jpg, png, webp — tối đa 2MB)</small></label>
                                ...
                                <div>
                                    <label class="form-label">URL Trailer (YouTube/Vimeo)</label>
                ...
                <div class="col-lg-4">
                    <div class="form-section" style="position:sticky; top:20px;">
                        ...
                        <p class="text-muted" style="font-size:13px;">Kiểm tra lại thông tin trước khi lưu. Các trường có dấu <span class="text-danger">*</span> là bắt buộc.</p>
