<header class="bg-surface border-b border-outline-variant h-16 w-full fixed top-0 pl-[280px] z-10 flex justify-between items-center pl-4 pr-10 transition-all duration-200 ease-in-out">
